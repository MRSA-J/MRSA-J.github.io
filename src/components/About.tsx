        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-300 mb-6">
              I am Groot! Just kidding, I'm Chen Wei 😊. When I'm not pretending to be a Marvel character, I'm a full-stack software engineer and machine learning enthusiast building cool stuff with code.
            </p>
            <p className="text-lg text-zinc-600 dark:text-zinc-300 mb-6">
